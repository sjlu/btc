client.controller('chart', function($scope, $http) {
  ...
  $scope.chartOpts = {
    ...
    series: [
      {y: 'dema-900-50', axis: 'y1', color: 'green', drawDots: true, dotSize: 2},
      {y: 'dema-900-25', axis: 'y1', color: 'blue', drawDots: true, dotSize: 2},
      {y: 'dema-900-10', axis: 'y1', color: 'red', drawDots: true, dotSize: 2},
